...
{
    public class UnloadedTerminalTimeslotVehicleStatusRule : ICalculateTerminalTimeslotVehicleStatusService
	{
		public List<TimeslotVehicle> Calculate(List<TimeslotVehicle> vehicleNotUnloadNotLeavingWithCargoNotInUnloadingAreaNotInCargoFrame)
		{
			...
			return new List<TimeslotVehicle> { new TimeslotVehicle() { TerminalTimeslotVehicleId = 14 }};
		}
	}
}